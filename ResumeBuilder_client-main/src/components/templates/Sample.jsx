      ...
      <section className={classes.resume_container}>
        ...
        <section className={classes.intro_section}>
          <div className={classes.left}>
            <h3 className={classes.bigger}>{`${resumeInfo?.resumeData?.basicDetails?.firstName} ${resumeInfo?.resumeData?.basicDetails?.lastName}`}</h3>
            <p>{resumeInfo?.resumeData?.basicDetails?.branch}</p>
            <p>{resumeInfo?.resumeData?.basicDetails?.collegeName}</p>
          </div>
          <div className={classes.right}>
            <a href= {resumeInfo?.resumeData?.basicDetails?.linkedin}>
              Linkedin profile
            </a>
            <a href={resumeInfo?.resumeData?.basicDetails?.Github}>Github profile </a>
            <a >{resumeInfo?.resumeData?.basicDetails?.email}</a>
          </div>
        </section>
